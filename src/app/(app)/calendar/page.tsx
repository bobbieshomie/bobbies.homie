...
export default function CalendarPage() {
  ...
  // Calendar dates calculation using viewYear/viewMonth
  ...
  // Group events by day of viewYear/viewMonth
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FDFBF7] dark:bg-[#141312] select-none max-w-[420px] mx-auto pb-28 no-scrollbar transition-colors duration-200">
      ...
      {/* Month Label only (no nav arrows here) */}
      ...
      <div className="px-6 pb-4">
        <div className="p-3.5 bg-white dark:bg-[#1F1D1B] border border-[#D7CCC8] dark:border-[#2E2A27] rounded-[22px] shadow-[0px_4px_16px_rgba(93,64,55,0.03)]">
          ...
          {/* Month Navigation Row — below the grid */}
            ...
            <form onSubmit={handleCreateEvent} className="space-y-3.5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="text-[12px] font-medium text-[#8D6E63] dark:text-[#948D87]">
                  ...
                  <button
                    ...
                    className={`relative w-10 h-5.5 rounded-full transition-colors cursor-pointer ${
                      showTime ? 'bg-[#5D4037] dark:bg-[#6E544A]' : 'bg-[#D7CCC8] dark:bg-[#2E2A27]'
                    }`}
                    style={{ height: '22px', width: '40px' }}
                  >
                    <span
                      className={`absolute top-[3px] w-4 h-4 bg-white rounded-full shadow transition-transform ${
                        showTime ? 'translate-x-[20px]' : 'translate-x-[3px]'
                      }`}
                    />
                  </button>
                </div>
              ...
              {/* Assign To — custom styled select */}
              <div>
                <label className="block text-[12px] font-medium text-[#8D6E63] dark:text-[#948D87] mb-1">
