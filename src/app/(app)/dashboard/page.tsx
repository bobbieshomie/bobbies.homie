...
export default function DashboardPage() {
  ...
  return (
    <div className="home-dashboard flex flex-col justify-between items-start p-0 relative w-full max-w-[402px] min-h-[874px] bg-[#FDFBF7] dark:bg-[#1F1511] mx-auto select-none transition-colors duration-200">
      {/* scrollable-content */}
      <div className="scrollable-content flex flex-col items-start p-0 w-full flex-none order-0 self-stretch flex-grow-0">
        ...
        <div className="flex flex-row justify-between items-center px-6 pt-4 pb-1 w-full flex-none order-0 self-stretch flex-grow-0">
          <div className="flex items-center gap-1.5">
            <RiBearSmileFill className="w-4 h-4 fill-[#5D4037] dark:fill-[#F5EBE6]" />
            <span className="font-dm-sans font-medium text-[12px] text-[#8D6E63] dark:text-[#BCAAA4]">
        ...
        <header className="dashboard-header flex flex-col items-start px-6 pt-2 pb-4 gap-4 w-full flex-none order-1 self-stretch flex-grow-0">
          <div className="header-row flex flex-row justify-between items-center p-0 w-full flex-none order-0 self-stretch flex-grow-0">
            ...
            <div className="greeting-info flex flex-col items-start p-0 gap-1 flex-none order-0 flex-grow-0">
              <h1 className="font-outfit font-bold text-[26px] leading-[32px] text-[#5D4037] dark:text-[#F5EBE6] flex-none order-0 flex-grow-0">
                {greeting}, {profile.myNickname || (language === 'th' ? 'เพื่อนร่วมบ้าน' : 'Homie')}
              </h1>
              <p className="font-dm-sans font-normal text-[14px] leading-[18px] text-[#8D6E63] dark:text-[#BCAAA4] flex-none order-1 flex-grow-0">
                {formatCurrentDate()}
              </p>
            </div>
            ...
            >
              <div 
                ...
                className="box-border flex flex-col justify-center items-center p-0 w-[40px] h-[40px] bg-[#D7CCC8] dark:bg-[#35231C] border-2 border-white dark:border-[#4E342E] rounded-[20px] flex-none order-0 flex-grow-0 shadow-sm z-10 text-[#5D4037] dark:text-[#F5EBE6] overflow-hidden"
              >
                {activeUserAvatar ? (
              ...
              {members.length > 1 ? (
                <div 
                  ...
                  className="box-border flex flex-col justify-center items-center p-0 w-[40px] h-[40px] bg-[#EFEBE9] dark:bg-[#2D1E18] border-2 border-white dark:border-[#4E342E] rounded-[20px] flex-none order-1 flex-grow-0 -ml-[10px] shadow-sm z-0 text-[#8D6E63] dark:text-[#BCAAA4] overflow-hidden"
                >
                ...
                <div 
                  ...
                  className="box-border flex flex-col justify-center items-center p-0 w-[24px] h-[24px] bg-[#F4EFEA] dark:bg-[#2D1E18] border border-[#D7CCC8] dark:border-[#4E342E] rounded-full flex-none order-1 flex-grow-0 -ml-[8px] shadow-xs z-0 text-[#8D6E63] dark:text-[#BCAAA4]"
                >
        ...
        <main className="dashboard-body flex flex-col items-start px-6 p-0 gap-5 w-full flex-none order-2 self-stretch flex-grow-0">
          ...
          {/* chore-progress-card */}
          <section className="chore-progress-card box-border flex flex-col items-start p-5 gap-3 w-full bg-[#F4EFEA] dark:bg-[#2D1E18] border border-[#D7CCC8] dark:border-[#4E342E] shadow-[0px_4px_16px_rgba(93,64,55,0.039)] rounded-[24px] flex-none order-0 self-stretch flex-grow-0 transition-colors">
            <div className="card-split flex flex-row items-center p-0 gap-4 w-full min-h-[95px] flex-none order-0 self-stretch flex-grow-0">
              ...
              <div className="progress-left flex flex-col items-start p-0 gap-1.5 flex-1 min-h-[95px] flex-none order-0 flex-grow-1">
                <h2 className="font-outfit font-bold text-[18px] leading-[23px] text-[#5D4037] dark:text-[#F5EBE6]">
                  {t.dashboard.todayChores}
                </h2>
                <p className="font-dm-sans font-normal text-[13px] leading-[17px] text-[#8D6E63] dark:text-[#BCAAA4]">
                  {choreStats.total > 0
              ...
              <div className="progress-ring-container flex flex-col justify-center items-center p-0 isolate relative w-[80px] h-[80px] flex-none order-1 flex-grow-0 shrink-0">
                <svg className="w-[80px] h-[80px] -rotate-90" viewBox="0 0 80 80">
                  <circle
                    ...
                    fill="#FFFFFF"
                    stroke="#FFFFFF"
                    className="dark:fill-[#1F1511] dark:stroke-[#1F1511]"
                    strokeWidth="7"
                  />
                  <circle
                    cx="40"
                ...
                <div className="center-label flex flex-col items-center p-0 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                  <span className="font-outfit font-bold text-[16px] leading-[20px] text-[#5D4037] dark:text-[#F5EBE6]">
                    {choreStats.percent}%
                  </span>
                </div>
              </div>
          ...
          <section className="summaries-grid flex flex-row items-start p-0 gap-3 w-full flex-none order-1 self-stretch flex-grow-0">
            ...
            <Link
              href="/shopping"
              className="shopping-summary box-border flex flex-col items-start p-4 gap-3 flex-1 h-[123px] bg-[#F4EFEA] dark:bg-[#2D1E18] border border-[#D7CCC8] dark:border-[#4E342E] shadow-[0px_4px_16px_rgba(93,64,55,0.039)] rounded-[24px] flex-none order-0 self-stretch flex-grow-1 transition-transform active:scale-[0.98]"
            >
              ...
              <div className="flex flex-col items-start p-0 gap-0.5 w-full">
                <span className="font-outfit font-bold text-[20px] leading-[26px] text-[#5D4037] dark:text-[#F5EBE6]">
                  {shoppingCount} {t.common.items}
                </span>
                <span className="font-dm-sans font-normal text-[12px] leading-[16px] text-[#8D6E63] dark:text-[#BCAAA4] truncate w-full">
            ...
            <Link
              href="/pets"
              className="pet-summary box-border flex flex-col items-start p-4 gap-3 flex-1 h-[123px] bg-[#F4EFEA] dark:bg-[#2D1E18] border border-[#D7CCC8] dark:border-[#4E342E] shadow-[0px_4px_16px_rgba(93,64,55,0.039)] rounded-[24px] flex-none order-1 self-stretch flex-grow-1 transition-transform active:scale-[0.98]"
            >
              <div className="card-header flex flex-row justify-between items-center p-0 w-full h-[32px]">
              ...
              <div className="flex flex-col items-start p-0 gap-0.5 w-full">
                <span className="font-outfit font-bold text-[16px] leading-[22px] text-[#5D4037] dark:text-[#F5EBE6] truncate w-full">
          ...
          <Link
            href="/finances"
            className="finance-balance-card box-border flex flex-col items-start p-5 gap-3 w-full bg-[#FFFFFF] dark:bg-[#2D1E18] border border-[#D7CCC8] dark:border-[#4E342E] shadow-[0px_4px_16px_rgba(93,64,55,0.039)] rounded-[24px] flex-none order-2 self-stretch flex-grow-0 transition-transform active:scale-[0.99] cursor-pointer"
          >
            <div className="card-top flex flex-row justify-between items-center p-0 w-full h-[47px]">
              <div className="label-container flex flex-col items-start p-0 gap-0.5">
                <span className="font-outfit font-semibold text-[13px] leading-[16px] text-[#8D6E63] dark:text-[#BCAAA4] tracking-wide">
                  {t.dashboard.financeTitle}
                </span>
                <h3 className="font-outfit font-bold text-[18px] leading-[23px] text-[#5D4037] dark:text-[#F5EBE6]">
            ...
            <div className="balance-amount flex flex-row items-center p-0 gap-2 w-full h-[40px]">
              <span className="font-outfit font-bold text-[28px] leading-[36px] text-[#5D4037] dark:text-[#F5EBE6]">
                ฿{financeBalance.toFixed(2)}
              </span>

              <div className="status-pill flex flex-row items-center px-2.5 py-1 bg-[#F4EFEA] dark:bg-[#1F1511] border border-[#D7CCC8] dark:border-[#4E342E] rounded-[12px]">
                <span className="font-dm-sans font-medium text-[11px] text-[#5D4037] dark:text-[#F5EBE6]">
          ...
          <section className="quick-actions-section flex flex-col items-start p-0 gap-3 w-full flex-none order-3 self-stretch flex-grow-0 pb-6">
            <h4 className="font-outfit font-bold text-[16px] leading-[20px] text-[#5D4037] dark:text-[#F5EBE6]">
            ...
            <div className="action-buttons flex flex-row items-start p-0 gap-2 w-full h-[42px]">
              <Link
                href="/create?tab=chores"
                className="box-border flex flex-row justify-center items-center py-2 px-2.5 gap-1.5 flex-1 h-[42px] bg-[#F4EFEA] dark:bg-[#2D1E18] border border-[#D7CCC8] dark:border-[#4E342E] rounded-[16px] cursor-pointer transition-transform active:scale-95 text-[#5D4037] dark:text-[#F5EBE6]"
              >
              ...
              <Link
                href="/create"
                className="box-border flex flex-row justify-center items-center py-2 px-2.5 gap-1.5 flex-1 h-[42px] bg-[#5D4037] dark:bg-[#4E342E] hover:bg-[#4A332C] text-white rounded-[16px] cursor-pointer transition-transform active:scale-95 shadow-xs"
              >
